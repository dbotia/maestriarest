...
import com.udea.maestriarest.modelo.DiscountCode;
 ...
 */
@Stateless
@Path("com.udea.maestriarest.modelo.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.udea_MaestriaREST_war_1.0-SNAPSHOTPU")
